        ...
        <div class="container-fluid h-100 p-5" id="container">
            ...
            <div class="row ml-5 pl-5 justify-content-start ">
                ...
                <div class="col-12 col-lg-4">
                    ...
                    <button type="button" class="btn btn-light btn-lg mr-3 "><a href="register.php">Sign Up</a></button>
                    <button type="button" class="btn btn-light btn-lg"> <a href="login.php">Login</a></button>
                </div>
            </div>
